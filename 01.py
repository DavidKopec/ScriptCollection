...
PATH_SMD:str = f"{os.getcwd()}/SMD" # to do !!
PATH_DEP:str = "/mnt/storage-brno14-ceitec/shared/softmatter/kopec/Masters/02MP1_CG/01MembranesOnly/001MDPs" # to do --> path to scripts and md file for sampling
...
def phase01() -> None:
    ...
    os.system(f"cp {PATH_SMD}/md*.xtc} ./{PATH_SMD}/storage/")
...
def phase03_custom() ->None:
    ...
    frames_arr = np.arange(div,traj_len,div)
